...
class word2vec(object):
	...
	def __init__(self, vector_fn):
		...
		for line in open(vector_fn, encoding="utf-8"):
			line = line.split()
...
def get_paranmt_usif():
	...
	prob = word2prob(os.path.join(".", "data", "usif", "enwiki_vocab_min200.txt"))
	vec = word2vec(os.path.join(".", "data", "usif", "vectors/czeng.txt"))
