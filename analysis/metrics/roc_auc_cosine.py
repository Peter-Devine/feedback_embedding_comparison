...
class Metric:
    ...
    def calculate(self, embeddings):
        ...
        # Make the nan values (distances to sentences with 0 vector sentence embeddings) 2, the maximum for cosine distance
        mutual_distances[np.isnan(mutual_distances)] = 2
